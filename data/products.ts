...
export const allProducts: Product[] = [
  ...
  {
    id: 6,
    name: "Caixa e Carta Personalizada com o nome do seu amado, ursinho tamanho P e chocolates",
    code: "Código: CRUD-AMOR",
    image: "https://res.cloudinary.com/dqknds48u/image/upload/v1748804993/WhatsApp_Image_2025-06-01_at_15.51.01_qxthtb.jpg",
    price: 29.90,
  ...
  {
    id: 14,
    name: "Cesta Romântica de Chocolates e Ursinho",
    code: "Código: CRLB-AMOR",
    image: "https://res.cloudinary.com/dqknds48u/image/upload/v1748809038/WhatsApp_Image_2025-06-01_at_16.20.29_alqihi.jpg",
    price: 39.90,
    installments: "2x de R$ 20,00",
    category: ["cestas", "cestas-romanticas", "destaques"],
  },
  {
    id: 15,
